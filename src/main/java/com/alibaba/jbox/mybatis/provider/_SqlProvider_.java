package com.alibaba.jbox.mybatis.provider;

import com.alibaba.jbox.mybatis.sequence.SequenceRegistry;
import com.alibaba.jbox.mybatis.BaseEntity;
import com.alibaba.jbox.mybatis.Table;
import com.alibaba.jbox.mybatis.Where;
...
import static com.alibaba.jbox.mybatis.provider.Helpers.*;
...
public class _SqlProvider_ {
    ...
    public static String insert(ProviderContext context, BaseEntity<? extends Serializable> entity) {
        ...
        if (entity.getId() != null) {
            columns.add("`id`");
            fields.add("#{id}");
        } else if (Table.PRI_SEQUENCE_INSTANCE.equals(table.primaryKey)) {
